...
TIMELINE = [
    {"id": "S01", "start": 0.0, "end": 10.12},
    {"id": "S02", "start": 10.12, "end": 21.56},
    {"id": "S03", "start": 21.56, "end": 27.56},
    {"id": "S04", "start": 27.56, "end": 43.60},
    {"id": "S05", "start": 43.60, "end": 51.24},
]
TOTAL_DURATION = 51.24
COVER_DURATION = 1.0

SUBTITLES = [
    {"start": 0.0, "end": 10.12, "text": "说一个房产中介不会告诉你的事。同一个小区，挂牌价和真实成交价，能差20%。"},
    {"start": 10.12, "end": 21.56, "text": "干了10年的中介，看一眼就知道——这套房业主急卖，砍15%没问题。那套房学区是坑，别碰。"},
    {"start": 21.56, "end": 27.56, "text": "你在APP上刷三个月，不如一个干了10年的人带你看一次。"},
    {"start": 27.56, "end": 43.60, "text": "但中介按成交价抽佣，他不会告诉你底价。只有被裁了的那个中介，才敢说真话。"},
    {"start": 43.60, "end": 51.24, "text": "收藏这条，买房前拿出来看看。你觉得买房最大的坑是什么？评论区聊聊。"},
]

DANMAKU = [
    "中介不会说的", "差20%太真实", "急卖砍15%",
    "学区是坑", "APP刷没用", "被裁的才说真话",
    "收藏了买房前看", "底价不告诉你", "评论区聊聊",
    "买房必看", "转给要买房的人",
]
