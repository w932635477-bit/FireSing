...
TIMELINE = [
    {"id": "S01", "start": 0.0, "end": 4.78},
    {"id": "S02", "start": 4.78, "end": 17.76},
    {"id": "S03", "start": 17.76, "end": 25.28},
    {"id": "S04", "start": 25.28, "end": 32.47},
    {"id": "S05", "start": 32.47, "end": 37.48},
]
TOTAL_DURATION = 37.48
COVER_DURATION = 1.0

SUBTITLES = [
    {"start": 0.0, "end": 4.78, "text": "每个行业都有这种人——工资配不上脑子里的东西。"},
    {"start": 4.78, "end": 17.76, "text": "外贸老炮年入18万，帮客户省300万。装修工头日薪400，避坑门道值2000。"},
    {"start": 17.76, "end": 25.28, "text": "你的工资不是你的价值，是你老板愿意付你的最低价。"},
    {"start": 25.28, "end": 32.47, "text": "人才市场标价500一小时，你真正的客户不是HR。"},
    {"start": 32.47, "end": 37.48, "text": "@一个被低估的朋友，评论区说说他有多懂行。"},
]

DANMAKU = [
    "说得太对了", "我就是那个人", "18万vs300万",
    "工资是最低价", "日薪400太真实", "500一小时才对",
    "HR不配", "懂行的都穷", "转发给老板看",
]
